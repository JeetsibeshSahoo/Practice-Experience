    ...
    <DashboardLayout>
        ...
        <div className='h-full w-full p-6 relative overflow-hidden'>
            ...
            <div className='relative z-10'>
                <h1 className='text-5xl font-extrabold mb-10 bg-linear-to-r from-purple-400 via-pink-500 to-red-500 text-transparent bg-clip-text'>
                    Welcome {user?.name} 👋
                </h1>
                ...
                <div className='mt-10 flex gap-4'>
                    <button className='px-6 py-2 rounded-full bg-linear-to-r from-purple-500 to-pink-500 transition shadow-lg'>
                        Explore 🚀
                    </button>
